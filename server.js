...
// ALSO serve HTML files directly from root (for Render)
app.get('/', (req, res) => {
...
app.listen(PORT, () => {
  ...
  console.log(`📍 https://crowd-funding-9pug.onrender.com`);
  console.log(`🔐 Admin Dashboard: https://crowd-funding-9pug.onrender.com/admin.html`);
  console.log(`📋 Privacy Policy: https://crowd-funding-9pug.onrender.com/privacy.html`);
  console.log(`📋 Terms of Service: https://crowd-funding-9pug.onrender.com/terms.html`);
});
